...
os.chdir("E:/Sruthi/Open CV/Lesson 6/imagesh")
path="E:/Sruthi/Open CV/Lesson 6/imagesh"

mean_height=0
mean_width=0
image_files=[file for file in os.listdir('.') if file.endswith(('.jpg', '.jpeg', '.png','.jfif'))]
...
def videoGenerator():
    ...
    for img in image_files:
        if img.endswith('.jpg') or img.endswith('.jpeg') or img.endswith('.png') or img.endswith(".jfif"):
            images.append(img)
    print(images)
